""" Configuration page for the entire credit risk pipeline
Mainting the dataset schema, file paths and key hyperparameters at one place
...
class Schema:
    ...
    numeric_features: tuple[str, ...] = (           # continuous figures, scale it
    ...
    delinquency_counts: tuple[str, ...] = (       # contains 96/98 - no history/closed ccount, special handling
